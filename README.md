...
> Portfolio pessoal com foco em mostrar meus conhecimentos para serviços de freelance na area de desenvolvimento.
...
```bash
git clone https://github.com/alextfonseca/Portfolio.git
$ cd Portfolio
$ yarn / npm i
$ yarn dev / npm dev
```
...
# <a href="https://alextfonseca.vercel.app">Acesse o projeto</a>
